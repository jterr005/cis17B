...
if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
	...
	$q = "SELECT COUNT(user_id) FROM jterrazas_entity_pacman_player";
...
switch ($sort) {
	...
	case 'e':
		...
		break;
	default:
		$order_by = 'fisrt_name ASC';
		$sort = 'fn';
		break;
}
	
// Define the query:
$q = "SELECT last_name, first_name, email, user_id FROM jterrazas_entity_pacman_player ORDER BY $order_by LIMIT $start, $display";		
...
<tr>
	...
	<td align="left"><b><a href="view_users.php?sort=e">Email</a></b></td>
</tr>
';
